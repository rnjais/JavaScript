...
console.log(typeof(modifyarry));//String

//+++++++++++++++++Slice++++++++++++++

console.log("Original Array",anotherArray);
const myn1 = anotherArray.slice(1,3);
console.log("Slice",myn1);//[ 4, 6 ]
console.log("After Slice Original Array",anotherArray);// Nothing changed in Array after Slice

//++++++++++++++++Splice++++++++++++++++++++++
console.log("Original Array",anotherArray);//Original Array [ 2, 4, 6, 8 ]
console.log("After Splice ",anotherArray.splice(3,2));// Splice  [ 8 ]
console.log("Original Array",anotherArray);//After Splice Original Array [ 2, 4, 6 ]
